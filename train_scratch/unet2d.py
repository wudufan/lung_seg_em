...
class unet2d:
    ...
    def build_unet_multiclass(self):
        ...
        self.dices = 1 - (2 * tf.reduce_sum(self.Y[...,1:] * self.pred[...,1:], (1,2,3)) + self.dice_smooth)         / (tf.reduce_sum(self.Y[...,1:], (1,2,3)) + tf.reduce_sum(self.pred[...,1:], (1,2,3)) + self.dice_smooth)
